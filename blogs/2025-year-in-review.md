...
- **State estimation and causal reasoning in partially observable, safety-critical systems**. Latent failures, delayed effects, and sparse telemetry present significant challenges for classical model-based approaches and purely data-driven methods.
- **Task-conditioned perception heuristics that better leverage geometry and physical priors**. This affords stronger semantic understanding (e.g. depth, segmentation, affordances) at a fraction of the compute cost compared to general-purpose VLMs.
- **Models that utilize learned dynamics constrained by physical laws**. This enables robust planning and control in highly uncertain environments where analytical models are largely incomplete.
